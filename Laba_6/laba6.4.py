...
def read_courses():
    try:
        ...
        print("Ошибка: Файл 'udemy_courses.csv' не найден")
        return []
...
def analyze_courses():
    ...
    print(
        f"d. Уровень, для которого было создано наибольшее количество курсов: {most_popular_level} ({levels[most_popular_level]} курсов)")
